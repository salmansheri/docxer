...
import {
  ...
  FileTextIcon,
  GlobeIcon,
  PrinterIcon, Redo2Icon, TextIcon,
  TrashIcon,
  Undo2Icon
} from "lucide-react";
      ...
      <div className={"flex gap-2 items-center"}>
        ...
        <div className={"flex flex-col"}>
          ...
          <div className={"flex"}>
            ...
            >
              <MenubarMenu>
                <MenubarTrigger className="text-sm font-normal py-0.5 px-[7px] rounded-sm hover:bg-muted hover:text-white h-auto">File</MenubarTrigger>
                <MenubarContent>
                  <MenubarSub>
                    <MenubarSubTrigger>
